...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        productos[2] = new TvLcd(340000, "lg",40);
        productos[3] = new Libro(18000,  "Elementos reusables POO", "Alguna...","sas");
        productos[4] = new Libro(14000, "UML Gota a Gota", "Alguna...","sas");
        productos[5] = new Comics(5000,  "Condorito", "Alguna...", "Condorito","superman");
